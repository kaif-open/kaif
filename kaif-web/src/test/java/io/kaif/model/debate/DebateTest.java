...
public class DebateTest implements ModelFixture {
  ...
  public void debateWithLink() throws Exception {
    ...
    assertEquals(
        "<p>pixel art is better at <a href=\"http://www.google.com\" class=\"reference-link\" rel=\"noopener nofollow\" target=\"_blank\">9gaga</a><span class=\"reference-link-index\">1</span></p>\n"
            + "<div class=\"reference-appendix-block\"><div class=\"reference-appendix-index\">1</div><div  class=\"reference-appendix-wrap\"><a href=\"http://www.google.com\" rel=\"noopener nofollow\" target=\"_blank\">http://www.google.com</a></div>\n"
            + "</div>",
        debate.getRenderContent());
  }
