...
<#macro honorRoll data>
<div class="aside-card">
    <h4>排行榜</h4>

    <div class="aside-card-box">
        <table class="pure-table-horizontal honor-roll-table">
            <thead>
            <tr>
                <th>排名</th>
                <th>積分</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="honor-roll-user"
                           href="<@url.account data=honorRoll/>"><@url.account data=honorRoll/></a>
                    </td>
                </tr>
                </#list>
            </tbody>
